...
export type ComboCategorySummaryFragment = (
  { __typename?: 'ComboCategory' }
  & Pick<ComboCategory, 'id' | 'name'>
);
...
export type MoveCategorySummaryFragment = (
  { __typename?: 'MoveCategory' }
  & Pick<MoveCategory, 'id' | 'name'>
);
...
export const ComboCategorySummaryFragmentDoc = gql`
    fragment comboCategorySummary on ComboCategory {
  id
  name
}
    `;
...
export const EventFragmentDoc = gql`
  ...
  startsAt
    ...
    `;
export const MoveCategorySummaryFragmentDoc = gql`
    fragment moveCategorySummary on MoveCategory {
  id
  name
}
    `;
...
export const CreateMoveVideoDocument = gql`
    mutation CreateMoveVideo($characterId: ID!) {
  createMoveVideo(input: {characterId: $characterId}) {
    moveVideo {
      id
    }
    videoUpload {
...
export const ComboCategoriesDocument = gql`
  ...
  comboCategories(characterSlug: $characterSlug) {
    ...comboCategorySummary
  }
}
    ${ComboCategorySummaryFragmentDoc}`;
...
export const MoveCategoriesDocument = gql`
  ...
  moveCategories(characterSlug: $characterSlug) {
    ...
    ${MoveCategorySummaryFragmentDoc}`;
