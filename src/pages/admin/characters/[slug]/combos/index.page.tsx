...
import { AdminContent, AdminBreadcrumbs, ComboDashboard } from '@/components';
...
const Page: React.FC = () => {
  ...
  return (
    <AdminContent title="コマンドリスト" breadcrumb={<AdminBreadcrumbs to="combos" character={character} />}>
