...
import {
  ...
  useAdminMoveCategoriesPageQuery,
...
const Page: React.FC = () => {
  ...
  const { data, loading, updateQuery } = useAdminMoveCategoriesPageQuery({
...
interface MoveRowProps {
  move: AdminMoveCategoriesPageMoveFragment;
...
const VideoButton: React.FC<{ move: AdminMoveCategoriesPageMoveFragment }> = ({ move }) => {
