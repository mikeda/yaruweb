...
import {
  AdminTournamentsPageTournamentFragment,
  useAdminTournamentsPageQuery,
...
const Page: React.FC = () => {
  ...
  const { data, loading, fetchMore, updateQuery } = useAdminTournamentsPageQuery();
...
interface TournamentRowProps {
  tournament: AdminTournamentsPageTournamentFragment;
  onDelete: () => void;
}
