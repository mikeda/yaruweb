...
export type ThrowMoveFragment = { __typename?: 'ThrowMove', id: string, throwType: ThrowTypeEnum, startUpFrame?: number | null | undefined, damage?: number | null | undefined, throwEscape: ThrowEscapeEnum, throwResult: ThrowMoveResultEnum };
