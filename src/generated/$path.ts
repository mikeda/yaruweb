export const pagesPath = {
  ...
  characters: {
    _slug: (slug: string | number) => ({
      battles: {
        $url: (url?: { hash?: string }) => ({
          pathname: '/characters/[slug]/battles' as const,
          query: { slug },
          hash: url?.hash,
        }),
      },
      combos: {
        $url: (url?: { hash?: string }) => ({
          pathname: '/characters/[slug]/combos' as const,
          query: { slug },
          hash: url?.hash,
        }),
      },
      moves: {
        $url: (url?: { hash?: string }) => ({
          pathname: '/characters/[slug]/moves' as const,
          query: { slug },
          hash: url?.hash,
        }),
      },
      $url: (url?: { hash?: string }) => ({
        pathname: '/characters/[slug]' as const,
        query: { slug },
        hash: url?.hash,
      }),
    }),
  ...
  dashboard: {
    articles: {
      _id: (id: string | number) => ({
        edit: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/articles/[id]/edit' as const,
            query: { id },
            hash: url?.hash,
          }),
        },
    ...
    characters: {
      _slug: (slug: string | number) => ({
        combos: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/characters/[slug]/combos' as const,
            query: { slug },
            hash: url?.hash,
          }),
        },
        edit: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/characters/[slug]/edit' as const,
            query: { slug },
            hash: url?.hash,
          }),
        },
        moves: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/characters/[slug]/moves' as const,
            query: { slug },
            hash: url?.hash,
          }),
        },
    ...
    players: {
      _slug: (slug: string | number) => ({
        edit: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/players/[slug]/edit' as const,
            query: { slug },
            hash: url?.hash,
          }),
        },
    ...
    tournament_videos: {
      _id: (id: string | number) => ({
        battles: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/tournament_videos/[id]/battles' as const,
            query: { id },
            hash: url?.hash,
          }),
        },
        edit: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/tournament_videos/[id]/edit' as const,
            query: { id },
            hash: url?.hash,
          }),
        },
    ...
    tournaments: {
      _id: (id: string | number) => ({
        edit: {
          $url: (url?: { hash?: string }) => ({
            pathname: '/dashboard/tournaments/[id]/edit' as const,
            query: { id },
            hash: url?.hash,
          }),
        },
  ...
  players: {
    _slug: (slug: string | number) => ({
      battles: {
        $url: (url?: { hash?: string }) => ({
          pathname: '/players/[slug]/battles' as const,
          query: { slug },
          hash: url?.hash,
        }),
      },
      standings: {
        $url: (url?: { hash?: string }) => ({
          pathname: '/players/[slug]/standings' as const,
          query: { slug },
          hash: url?.hash,
        }),
      },
