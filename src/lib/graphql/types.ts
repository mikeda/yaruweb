...
/** Autogenerated input type of CreateWinning */
export type CreateWinningInput = {
  tournamentId: Scalars['ID'];
  attributes: WinningAttributes;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
};

/** Autogenerated return type of CreateWinning */
export type CreateWinningPayload = {
  __typename?: 'CreateWinningPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  winning: Winning;
};
...
/** Autogenerated input type of DeleteWinning */
export type DeleteWinningInput = {
  winningId: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
};

/** Autogenerated return type of DeleteWinning */
export type DeleteWinningPayload = {
  __typename?: 'DeleteWinningPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  winning: Winning;
};
...
export type Mutation = {
  ...
  createWinning?: Maybe<CreateWinningPayload>;
  ...
  deleteWinning?: Maybe<DeleteWinningPayload>;
  ...
  updateWinning?: Maybe<UpdateWinningPayload>;
};
...
export type MutationCreateWinningArgs = {
  input: CreateWinningInput;
};
...
export type MutationDeleteWinningArgs = {
  input: DeleteWinningInput;
};
...
export type MutationUpdateWinningArgs = {
  input: UpdateWinningInput;
};
...
/** Autogenerated input type of UpdateWinning */
export type UpdateWinningInput = {
  winningId: Scalars['ID'];
  attributes: WinningAttributes;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
...
/** Autogenerated return type of UpdateWinning */
export type UpdateWinningPayload = {
  __typename?: 'UpdateWinningPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  winning: Winning;
};
...
export type WinningCollection = {
  __typename?: 'WinningCollection';
  paging: Paging;
  records: Array<Winning>;
};
...
export type TournamentVideoFragment = { __typename?: 'TournamentVideo', id: string, youtubeVideoId: string, title: string, thumbnailUrl: string, commentCount: number, channel: { __typename?: 'Channel', name: string } };
...
export type DashboardTournamentCardFragment = { __typename?: 'Tournament', id: string, name: string, description: string, mainImageUrl?: Maybe<string>, startsAt: string, videosCount: number, winnings: Array<{ __typename?: 'Winning', id: string, place: number, player: { __typename?: 'Player', id: string, name: string } }> };
...
export type WinningCardFragment = { __typename?: 'Winning', id: string, place: number, player: { __typename?: 'Player', id: string, slug: string, name: string, avatarUrl?: Maybe<string> } };
...
export type DashboardTournamentPageQuery = { __typename?: 'Query', tournament: { __typename?: 'Tournament', id: string, name: string, description: string, mainImageUrl?: Maybe<string>, startsAt: string, winningsCount: number, videosCount: number, videos: Array<{ __typename?: 'TournamentVideo', id: string, title: string, youtubeVideoId: string }> }, players: { __typename?: 'PlayerCollection', records: Array<{ __typename?: 'Player', id: string, slug: string, name: string, tonamelId?: Maybe<string>, smashggId?: Maybe<string> }> } };

export type DashboardTournamentPageWinningsQueryVariables = Exact<{
  tournamentId: Scalars['ID'];
}>;


export type DashboardTournamentPageWinningsQuery = { __typename?: 'Query', winnings: { __typename?: 'WinningCollection', records: Array<{ __typename?: 'Winning', id: string, place: number, player: { __typename?: 'Player', id: string, name: string, avatarUrl?: Maybe<string> } }> } };
...
export type DashboardTournamentPageCreateWinningMutation = { __typename?: 'Mutation', createWinning?: Maybe<{ __typename?: 'CreateWinningPayload', winning: { __typename?: 'Winning', id: string } }> };

export type DashboardTournamentPageDeleteWinningMutationVariables = Exact<{
  winningId: Scalars['ID'];
}>;


export type DashboardTournamentPageDeleteWinningMutation = { __typename?: 'Mutation', deleteWinning?: Maybe<{ __typename?: 'DeleteWinningPayload', winning: { __typename?: 'Winning', id: string } }> };
...
export type DashboardTournamentsPageQuery = { __typename?: 'Query', tournaments: { __typename?: 'TournamentCollection', records: Array<{ __typename?: 'Tournament', id: string, name: string, description: string, mainImageUrl?: Maybe<string>, startsAt: string, videosCount: number, winnings: Array<{ __typename?: 'Winning', id: string, place: number, player: { __typename?: 'Player', id: string, name: string } }> }>, paging: { __typename?: 'Paging', currentPage: number, totalCount: number, totalPages: number, hasNext: boolean } } };

export type TopPageQueryVariables = Exact<{ [key: string]: never; }>;


export type TopPageQuery = { __typename?: 'Query', tournaments: { __typename?: 'TournamentCollection', records: Array<{ __typename?: 'Tournament', id: string, name: string, mainImageUrl?: Maybe<string>, startsAt: string }> }, battles: { __typename?: 'BattleCollection', records: Array<{ __typename?: 'Battle', id: string, round?: Maybe<BattleRound>, tournamentVideo: { __typename?: 'TournamentVideo', id: string, tournament: { __typename?: 'Tournament', id: string, name: string, startsAt: string } }, sides: Array<{ __typename?: 'BattleSide', rounds: number, player: { __typename?: 'Player', name: string }, character: { __typename?: 'Character', faceImageUrl: string } }> }> }, players: { __typename?: 'PlayerCollection', records: Array<{ __typename?: 'Player', id: string, slug: string, name: string, avatarUrl?: Maybe<string>, winningsCount: number, battlesCount: number }> }, characters: { __typename?: 'CharacterCollection', records: Array<{ __typename?: 'Character', slug: string, longName: string, faceImageUrl: string, country: string, fightingStyle: string }> }, articles: { __typename?: 'ArticleCollection', records: Array<{ __typename?: 'Article', id: string, title: string, description: string, mainImageUrl?: Maybe<string>, publishedAt?: Maybe<string>, faved: boolean, favsCount: number, status: ArticleStatus, author: { __typename?: 'User', name: string, avatarUrl: string } }> } };
...
export type PlayerBattlesPageQuery = { __typename?: 'Query', player: { __typename?: 'Player', slug: string, name: string, id: string, avatarUrl?: Maybe<string>, twitterId?: Maybe<string>, streamingUrl?: Maybe<string>, description?: Maybe<string>, winningsCount: number, battlesCount: number }, battleCounts: { __typename?: 'BattleCountCollection', records: Array<{ __typename?: 'BattleCount', id: string, count: number, character: { __typename?: 'Character', id: string, slug: string, name: string, faceImageUrl: string } }> }, battles: { __typename?: 'BattleCollection', records: Array<{ __typename?: 'Battle', id: string, round?: Maybe<BattleRound>, tournamentVideo: { __typename?: 'TournamentVideo', id: string, tournament: { __typename?: 'Tournament', id: string, name: string, startsAt: string } }, sides: Array<{ __typename?: 'BattleSide', rounds: number, player: { __typename?: 'Player', name: string }, character: { __typename?: 'Character', faceImageUrl: string } }> }>, paging: { __typename?: 'Paging', currentPage: number, totalCount: number, totalPages: number, hasNext: boolean } } };
...
export type PlayerPageQuery = { __typename?: 'Query', player: { __typename?: 'Player', slug: string, name: string, id: string, avatarUrl?: Maybe<string>, twitterId?: Maybe<string>, streamingUrl?: Maybe<string>, description?: Maybe<string>, winningsCount: number, battlesCount: number }, winnings: { __typename?: 'WinningCollection', records: Array<{ __typename?: 'Winning', id: string, place: number, tournament: { __typename?: 'Tournament', id: string, name: string, mainImageUrl?: Maybe<string>, startsAt: string } }>, paging: { __typename?: 'Paging', hasNext: boolean } }, battles: { __typename?: 'BattleCollection', records: Array<{ __typename?: 'Battle', id: string, round?: Maybe<BattleRound>, tournamentVideo: { __typename?: 'TournamentVideo', id: string, tournament: { __typename?: 'Tournament', id: string, name: string, startsAt: string } }, sides: Array<{ __typename?: 'BattleSide', rounds: number, player: { __typename?: 'Player', name: string }, character: { __typename?: 'Character', faceImageUrl: string } }> }>, paging: { __typename?: 'Paging', hasNext: boolean } } };
...
export type PlayerWinningsPageQuery = { __typename?: 'Query', player: { __typename?: 'Player', slug: string, name: string, id: string, avatarUrl?: Maybe<string>, twitterId?: Maybe<string>, streamingUrl?: Maybe<string>, description?: Maybe<string>, winningsCount: number, battlesCount: number }, winnings: { __typename?: 'WinningCollection', records: Array<{ __typename?: 'Winning', id: string, place: number, tournament: { __typename?: 'Tournament', id: string, name: string, mainImageUrl?: Maybe<string>, startsAt: string } }>, paging: { __typename?: 'Paging', currentPage: number, totalCount: number, totalPages: number, hasNext: boolean } } };
...
export type PlayerWinningsPageWinningsQuery = { __typename?: 'Query', winnings: { __typename?: 'WinningCollection', records: Array<{ __typename?: 'Winning', id: string, place: number, tournament: { __typename?: 'Tournament', id: string, name: string, mainImageUrl?: Maybe<string>, startsAt: string } }>, paging: { __typename?: 'Paging', currentPage: number, totalCount: number, totalPages: number, hasNext: boolean } } };
...
export type PlayersPageQuery = { __typename?: 'Query', players: { __typename?: 'PlayerCollection', records: Array<{ __typename?: 'Player', id: string, slug: string, name: string, avatarUrl?: Maybe<string>, winningsCount: number, battlesCount: number }>, paging: { __typename?: 'Paging', currentPage: number, totalCount: number, totalPages: number, hasNext: boolean } } };
...
export type PageTournamentVideoQuery = { __typename?: 'Query', tournamentVideo: { __typename?: 'TournamentVideo', id: string, youtubeVideoId: string, title: string, thumbnailUrl: string, commentCount: number, tournament: { __typename?: 'Tournament', id: string, name: string }, battles: Array<{ __typename?: 'Battle', id: string, round?: Maybe<BattleRound>, startSec: number, sides: Array<{ __typename?: 'BattleSide', rounds: number, player: { __typename?: 'Player', name: string }, character: { __typename?: 'Character', faceImageUrl: string } }> }>, channel: { __typename?: 'Channel', name: string } } };
...
export type PageTournamentQuery = { __typename?: 'Query', tournament: { __typename?: 'Tournament', id: string, name: string, mainImageUrl?: Maybe<string>, url: string, streamingUrl?: Maybe<string>, description: string, startsAt: string, winnings: Array<{ __typename?: 'Winning', id: string, place: number, player: { __typename?: 'Player', id: string, slug: string, name: string, avatarUrl?: Maybe<string> } }>, videos: Array<{ __typename?: 'TournamentVideo', id: string, title: string, thumbnailUrl: string }> } };
...
export const TournamentVideoCardFragmentDoc = gql`
  ...
  thumbnailUrl
    ...
    `;
export const WinningCardFragmentDoc = gql`
    fragment WinningCard on Winning {
  id
  place
  player {
    id
...
export const DashboardTournamentPageWinningsDocument = gql`
...
/**
 * __useDashboardTournamentPageWinningsQuery__
 *
 * To run a query within a React component, call `useDashboardTournamentPageWinningsQuery` and pass it any options that fit your needs.
 * When your component renders, `useDashboardTournamentPageWinningsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDashboardTournamentPageWinningsQuery({
 *   variables: {
 *      tournamentId: // value for 'tournamentId'
 *   },
 * });
 */
export function useDashboardTournamentPageWinningsQuery(baseOptions: Apollo.QueryHookOptions<DashboardTournamentPageWinningsQuery, DashboardTournamentPageWinningsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<DashboardTournamentPageWinningsQuery, DashboardTournamentPageWinningsQueryVariables>(DashboardTournamentPageWinningsDocument, options);
      }
export function useDashboardTournamentPageWinningsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<DashboardTournamentPageWinningsQuery, DashboardTournamentPageWinningsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<DashboardTournamentPageWinningsQuery, DashboardTournamentPageWinningsQueryVariables>(DashboardTournamentPageWinningsDocument, options);
        }
export type DashboardTournamentPageWinningsQueryHookResult = ReturnType<typeof useDashboardTournamentPageWinningsQuery>;
export type DashboardTournamentPageWinningsLazyQueryHookResult = ReturnType<typeof useDashboardTournamentPageWinningsLazyQuery>;
export type DashboardTournamentPageWinningsQueryResult = Apollo.QueryResult<DashboardTournamentPageWinningsQuery, DashboardTournamentPageWinningsQueryVariables>;
...
export const DashboardTournamentPageCreateWinningDocument = gql`
  ...
  createWinning(input: {tournamentId: $tournamentId, attributes: $attributes}) {
    ...
    `;
export type DashboardTournamentPageCreateWinningMutationFn = Apollo.MutationFunction<DashboardTournamentPageCreateWinningMutation, DashboardTournamentPageCreateWinningMutationVariables>;

/**
 * __useDashboardTournamentPageCreateWinningMutation__
 *
 * To run a mutation, you first call `useDashboardTournamentPageCreateWinningMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDashboardTournamentPageCreateWinningMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [dashboardTournamentPageCreateWinningMutation, { data, loading, error }] = useDashboardTournamentPageCreateWinningMutation({
 *   variables: {
 *      tournamentId: // value for 'tournamentId'
 *      attributes: // value for 'attributes'
 *   },
 * });
 */
export function useDashboardTournamentPageCreateWinningMutation(baseOptions?: Apollo.MutationHookOptions<DashboardTournamentPageCreateWinningMutation, DashboardTournamentPageCreateWinningMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DashboardTournamentPageCreateWinningMutation, DashboardTournamentPageCreateWinningMutationVariables>(DashboardTournamentPageCreateWinningDocument, options);
      }
export type DashboardTournamentPageCreateWinningMutationHookResult = ReturnType<typeof useDashboardTournamentPageCreateWinningMutation>;
export type DashboardTournamentPageCreateWinningMutationResult = Apollo.MutationResult<DashboardTournamentPageCreateWinningMutation>;
export type DashboardTournamentPageCreateWinningMutationOptions = Apollo.BaseMutationOptions<DashboardTournamentPageCreateWinningMutation, DashboardTournamentPageCreateWinningMutationVariables>;
export const DashboardTournamentPageDeleteWinningDocument = gql`
  ...
  deleteWinning(input: {winningId: $winningId}) {
    ...
    `;
export type DashboardTournamentPageDeleteWinningMutationFn = Apollo.MutationFunction<DashboardTournamentPageDeleteWinningMutation, DashboardTournamentPageDeleteWinningMutationVariables>;

/**
 * __useDashboardTournamentPageDeleteWinningMutation__
 *
 * To run a mutation, you first call `useDashboardTournamentPageDeleteWinningMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDashboardTournamentPageDeleteWinningMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [dashboardTournamentPageDeleteWinningMutation, { data, loading, error }] = useDashboardTournamentPageDeleteWinningMutation({
 *   variables: {
 *      winningId: // value for 'winningId'
 *   },
 * });
 */
export function useDashboardTournamentPageDeleteWinningMutation(baseOptions?: Apollo.MutationHookOptions<DashboardTournamentPageDeleteWinningMutation, DashboardTournamentPageDeleteWinningMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DashboardTournamentPageDeleteWinningMutation, DashboardTournamentPageDeleteWinningMutationVariables>(DashboardTournamentPageDeleteWinningDocument, options);
      }
export type DashboardTournamentPageDeleteWinningMutationHookResult = ReturnType<typeof useDashboardTournamentPageDeleteWinningMutation>;
export type DashboardTournamentPageDeleteWinningMutationResult = Apollo.MutationResult<DashboardTournamentPageDeleteWinningMutation>;
export type DashboardTournamentPageDeleteWinningMutationOptions = Apollo.BaseMutationOptions<DashboardTournamentPageDeleteWinningMutation, DashboardTournamentPageDeleteWinningMutationVariables>;
 ...
 *
 * To run a query within a React component, call `usePlayerWinningsPageQuery` and pass it any options that fit your needs.
 * When your component renders, `usePlayerWinningsPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function usePlayerWinningsPageQuery(baseOptions: Apollo.QueryHookOptions<PlayerWinningsPageQuery, PlayerWinningsPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PlayerWinningsPageQuery, PlayerWinningsPageQueryVariables>(PlayerWinningsPageDocument, options);
      }
export function usePlayerWinningsPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PlayerWinningsPageQuery, PlayerWinningsPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PlayerWinningsPageQuery, PlayerWinningsPageQueryVariables>(PlayerWinningsPageDocument, options);
        }
