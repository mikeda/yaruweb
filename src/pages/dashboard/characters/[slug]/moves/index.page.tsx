...
import { DashboardContent, AdminBreadcrumbs, MoveDashboard } from '@/components';
...
const Page: React.FC = () => {
  ...
  return (
    <DashboardContent title='コマンドリスト' breadcrumb={<AdminBreadcrumbs to='moves' character={character} />}>
