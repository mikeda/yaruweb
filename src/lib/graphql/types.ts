...
export type TournamentBattle = {
  ...
  sides: Array<TournamentBattleSide>;
...
export type TournamentBattleSide = {
...
export type TournamentBattleSideAttributes = {
  playerId: Scalars['ID'];
...
export const TournamentBattleFormFragmentDoc = gql`
  ...
  sides {
    ...
    `;
export const DashboardTournamentBattlesPageSideFragmentDoc = gql`
    fragment DashboardTournamentBattlesPageSide on TournamentBattleSide {
  player {
    id
    name
  }
...
export const DashboardTournamentBattlesPageBattleReslutFragmentDoc = gql`
  ...
  startSec
  sides {
    ...DashboardTournamentBattlesPageSide
  }
}
...
export const UpdateTournamentBattleDocument = gql`
    mutation UpdateTournamentBattle($tournamentBattleId: ID!, $attributes: TournamentBattleAttributes!) {
  updateTournamentBattle(
    input: {tournamentBattleId: $tournamentBattleId, attributes: $attributes}
  ) {
    tournamentBattle {
...
export type UpdateTournamentBattleMutationFn = Apollo.MutationFunction<UpdateTournamentBattleMutation, UpdateTournamentBattleMutationVariables>;

/**
 * __useUpdateTournamentBattleMutation__
 *
 * To run a mutation, you first call `useUpdateTournamentBattleMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateTournamentBattleMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateTournamentBattleMutation, { data, loading, error }] = useUpdateTournamentBattleMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateTournamentBattleMutation(baseOptions?: Apollo.MutationHookOptions<UpdateTournamentBattleMutation, UpdateTournamentBattleMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateTournamentBattleMutation, UpdateTournamentBattleMutationVariables>(UpdateTournamentBattleDocument, options);
      }
export type UpdateTournamentBattleMutationHookResult = ReturnType<typeof useUpdateTournamentBattleMutation>;
export type UpdateTournamentBattleMutationResult = Apollo.MutationResult<UpdateTournamentBattleMutation>;
export type UpdateTournamentBattleMutationOptions = Apollo.BaseMutationOptions<UpdateTournamentBattleMutation, UpdateTournamentBattleMutationVariables>;
