...
export type ComboFragment = { __typename?: 'Combo' } & Pick<Combo, 'id' | 'name' | 'damage' | 'note'> & {
    comboCategory: { __typename?: 'ComboCategory' } & Pick<ComboCategory, 'id' | 'name'>;
...
export type StageFragment = { __typename?: 'Stage' } & Pick<
  Stage,
  'id' | 'name' | 'mainImageUrl' | 'infinite' | 'wall' | 'wallBreak' | 'balconyBreak' | 'floorBreak' | 'position'
>;
...
export type CreateArticleVideoMutation = { __typename?: 'Mutation' } & {
  createArticleVideo?: Maybe<
    { __typename?: 'CreateArticleVideoPayload' } & {
      articleVideo: { __typename?: 'ArticleVideo' } & Pick<ArticleVideo, 'id' | 'm3u8Url' | 'thumbnailUrl'>;
...
export type UpdateAttackActionMutation = { __typename?: 'Mutation' } & {
  updateAttackAction?: Maybe<
    { __typename?: 'UpdateAttackActionPayload' } & {
      action: { __typename?: 'AttackAction' } & Pick<AttackAction, 'id'>;
    }
  >;
};
...
export type UpdateComboMutation = { __typename?: 'Mutation' } & {
  updateCombo?: Maybe<
    { __typename?: 'UpdateComboPayload' } & {
      combo: { __typename?: 'Combo' } & Pick<Combo, 'id'> & {
          comboCategory: { __typename?: 'ComboCategory' } & Pick<ComboCategory, 'id'>;
        };
    }
  >;
...
export type UpdateStagePositionMutation = { __typename?: 'Mutation' } & {
  updateStagePosition?: Maybe<
    { __typename?: 'UpdateStagePositionPayload' } & { stage: { __typename?: 'Stage' } & Pick<Stage, 'id'> }
  >;
};
...
export type ComboQuery = { __typename?: 'Query' } & { combo: { __typename?: 'Combo' } & ComboFragment };
...
export type PageDashboardActionEditQuery = { __typename?: 'Query' } & {
  action:
    | ({ __typename?: 'AttackAction' } & {
        move: { __typename?: 'Move' } & Pick<Move, 'id' | 'name'>;
...
export type PageDashboardMoveActionsQuery = { __typename?: 'Query' } & {
  move: { __typename?: 'Move' } & Pick<Move, 'id' | 'name'> & {
      actions: Array<
        | ({ __typename?: 'AttackAction' } & Action_AttackAction_Fragment)
        | ({ __typename?: 'ThrowAction' } & Action_ThrowAction_Fragment)
      >;
      moveCategory: { __typename?: 'MoveCategory' } & Pick<MoveCategory, 'id' | 'name'> & {
          character: { __typename?: 'Character' } & Pick<Character, 'slug' | 'name'>;
        };
    };
};
...
`;
export type UpdateAttackActionMutationFn = Apollo.MutationFunction<
  UpdateAttackActionMutation,
  UpdateAttackActionMutationVariables
>;
 ...
 * });
 */
export function useUpdateAttackActionMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateAttackActionMutation, UpdateAttackActionMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<UpdateAttackActionMutation, UpdateAttackActionMutationVariables>(
    UpdateAttackActionDocument,
    options,
  );
}
...
export type UpdateAttackActionMutationOptions = Apollo.BaseMutationOptions<
  UpdateAttackActionMutation,
  UpdateAttackActionMutationVariables
>;
...
`;
export type UpdateStagePositionMutationFn = Apollo.MutationFunction<
  UpdateStagePositionMutation,
  UpdateStagePositionMutationVariables
>;
 ...
 * });
 */
export function useUpdateStagePositionMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateStagePositionMutation, UpdateStagePositionMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<UpdateStagePositionMutation, UpdateStagePositionMutationVariables>(
    UpdateStagePositionDocument,
    options,
  );
}
...
export type UpdateStagePositionMutationOptions = Apollo.BaseMutationOptions<
  UpdateStagePositionMutation,
  UpdateStagePositionMutationVariables
>;
 ...
 * });
 */
export function usePageDashboardActionEditQuery(
  baseOptions: Apollo.QueryHookOptions<PageDashboardActionEditQuery, PageDashboardActionEditQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PageDashboardActionEditQuery, PageDashboardActionEditQueryVariables>(
    PageDashboardActionEditDocument,
    options,
  );
}
export function usePageDashboardActionEditLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<PageDashboardActionEditQuery, PageDashboardActionEditQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PageDashboardActionEditQuery, PageDashboardActionEditQueryVariables>(
    PageDashboardActionEditDocument,
    options,
  );
}
...
export type PageDashboardActionEditQueryResult = Apollo.QueryResult<
  PageDashboardActionEditQuery,
  PageDashboardActionEditQueryVariables
>;
 ...
 * });
 */
export function usePageDashboardMoveActionsQuery(
  baseOptions: Apollo.QueryHookOptions<PageDashboardMoveActionsQuery, PageDashboardMoveActionsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PageDashboardMoveActionsQuery, PageDashboardMoveActionsQueryVariables>(
    PageDashboardMoveActionsDocument,
    options,
  );
}
export function usePageDashboardMoveActionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<PageDashboardMoveActionsQuery, PageDashboardMoveActionsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PageDashboardMoveActionsQuery, PageDashboardMoveActionsQueryVariables>(
    PageDashboardMoveActionsDocument,
    options,
  );
}
...
export type PageDashboardMoveActionsQueryResult = Apollo.QueryResult<
  PageDashboardMoveActionsQuery,
  PageDashboardMoveActionsQueryVariables
>;
