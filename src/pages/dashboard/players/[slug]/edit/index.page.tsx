...
import { DashboardContent, AdminBreadcrumbs, PlayerForm } from '@/components';
...
const Page: React.FC = () => {
  ...
  return (
    <DashboardContent title='プレイヤー編集' breadcrumb={<AdminBreadcrumbs to='playerEdit' player={player} />}>
