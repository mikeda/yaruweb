...
/** Autogenerated input type of ConvertArticleVideo */
export type ConvertArticleVideoInput = {
  articleVideoId: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
};

/** Autogenerated return type of ConvertArticleVideo */
export type ConvertArticleVideoPayload = {
  __typename?: 'ConvertArticleVideoPayload';
...
export type Mutation = {
  __typename?: 'Mutation';
  convertArticleVideo?: Maybe<ConvertArticleVideoPayload>;
  ...
  setComboVideo?: Maybe<SetComboVideoPayload>;
...
export type MutationConvertArticleVideoArgs = {
  input: ConvertArticleVideoInput;
};
...
export type MutationSetComboVideoArgs = {
  input: SetComboVideoInput;
};
...
/** Autogenerated input type of SetComboVideo */
export type SetComboVideoInput = {
  comboId: Scalars['ID'];
  comboVideoId: Scalars['ID'];
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
...
/** Autogenerated return type of SetComboVideo */
export type SetComboVideoPayload = {
  __typename?: 'SetComboVideoPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  comboVideo: ComboVideo;
};
...
export type AttackActionFragment = { __typename: 'AttackAction' } & Pick<
  AttackAction,
  'id' | 'attackType' | 'damage'
> & { frames: Array<{ __typename?: 'Frame' } & Pick<Frame, 'id' | 'type' | 'frame' | 'state'>> };

export type ThrowActionFragment = { __typename: 'ThrowAction' } & Pick<
  ThrowAction,
  'id' | 'throwType' | 'damage' | 'escape'
> & { frames: Array<{ __typename?: 'Frame' } & Pick<Frame, 'id' | 'type' | 'frame' | 'state'>> };

type Action_AttackAction_Fragment = { __typename?: 'AttackAction' } & AttackActionFragment;

type Action_ThrowAction_Fragment = { __typename?: 'ThrowAction' } & ThrowActionFragment;

export type ActionFragment = Action_AttackAction_Fragment | Action_ThrowAction_Fragment;

export type ArticleFragment = { __typename?: 'Article' } & Pick<Article, 'category' | 'content'> &
  ArticleSummaryFragment;

export type ArticleCommentFragment = { __typename?: 'ArticleComment' } & Pick<
  ArticleComment,
  'id' | 'message' | 'createdAt'
> & { player: { __typename?: 'Player' } & Pick<Player, 'name' | 'avatarUrl'> };
...
export type ArticleSummaryFragment = { __typename?: 'Article' } & Pick<
  Article,
  'id' | 'title' | 'description' | 'mainImageUrl' | 'publishedAt' | 'faved' | 'favsCount' | 'status'
> & { author: { __typename?: 'Player' } & Pick<Player, 'name' | 'avatarUrl'> };

export type CharacterFragment = { __typename?: 'Character' } & Pick<Character, 'story' | 'description'> &
  CharacterSummaryFragment;

export type CharacterSummaryFragment = { __typename?: 'Character' } & Pick<
  Character,
  'slug' | 'longName' | 'faceImageUrl' | 'country' | 'fightingStyle'
>;

export type CharacterWithChildrenFragment = { __typename?: 'Character' } & {
  moveCategories: Array<{ __typename?: 'MoveCategory' } & MoveCategoryFragment>;
  comboCategories: Array<{ __typename?: 'ComboCategory' } & ComboCategoryFragment>;
} & CharacterFragment;

export type ComboFragment = { __typename?: 'Combo' } & Pick<Combo, 'id' | 'name' | 'damage' | 'note'> & {
    operations: Array<{ __typename?: 'Operation' } & OperationFragment>;
  };

export type ComboCategoryFragment = { __typename?: 'ComboCategory' } & Pick<ComboCategory, 'id' | 'name'>;

export type ComboCategoryDetailFragment = { __typename?: 'ComboCategory' } & Pick<ComboCategory, 'id' | 'name'> & {
    character: { __typename?: 'Character' } & CharacterFragment;
    combos: Array<{ __typename?: 'Combo' } & ComboFragment>;
  };

export type ComboCategoryWithCharacterFragment = { __typename?: 'ComboCategory' } & {
  character: { __typename?: 'Character' } & CharacterFragment;
} & ComboCategoryFragment;

export type CommandFragment = { __typename?: 'Command' } & Pick<Command, 'id'> & {
    state?: Maybe<{ __typename?: 'State' } & StateFragment>;
    operations: Array<{ __typename?: 'Operation' } & OperationFragment>;
  };

export type CurrentPlayerFragment = { __typename?: 'CurrentPlayer' } & Pick<
  CurrentPlayer,
  'id' | 'name' | 'slug' | 'role' | 'avatarUrl'
>;
...
export type HighlightFragment = { __typename?: 'Highlight' } & Pick<Highlight, 'id' | 'title' | 'startSec'> & {
    player: { __typename?: 'Player' } & Pick<Player, 'slug' | 'name'>;
  };

export type MoveFragment = { __typename?: 'Move' } & Pick<
  Move,
  | 'id'
  | 'name'
  | 'kana'
...
> & {
    ...
    actions: Array<
      | ({ __typename?: 'AttackAction' } & Action_AttackAction_Fragment)
      | ({ __typename?: 'ThrowAction' } & Action_ThrowAction_Fragment)
    >;
  };

export type MoveCategoryFragment = { __typename?: 'MoveCategory' } & Pick<MoveCategory, 'id' | 'name'>;

export type MoveCategoryDetailFragment = { __typename?: 'MoveCategory' } & Pick<MoveCategory, 'id' | 'name'> & {
    character: { __typename?: 'Character' } & CharacterFragment;
    moves: Array<{ __typename?: 'Move' } & MoveFragment>;
  };

export type MoveCategoryWithCharacterFragment = { __typename?: 'MoveCategory' } & {
  character: { __typename?: 'Character' } & CharacterFragment;
} & MoveCategoryFragment;

export type MoveCommentFragment = { __typename?: 'MoveComment' } & Pick<MoveComment, 'id' | 'message'>;

export type OperationFragment = { __typename?: 'Operation' } & Pick<Operation, 'id' | 'name' | 'key' | 'icon'>;

export type PagingFragment = { __typename?: 'PageInfo' } & Pick<PageInfo, 'hasNextPage' | 'endCursor'>;

export type StageFragment = { __typename?: 'Stage' } & Pick<
  Stage,
  'id' | 'name' | 'mainImageUrl' | 'infinite' | 'wall' | 'wallBreak' | 'balconyBreak' | 'floorBreak'
>;

export type StateFragment = { __typename?: 'State' } & Pick<State, 'id' | 'name'>;

export type TopPlayerFragment = { __typename?: 'TopPlayer' } & Pick<
  TopPlayer,
  'id' | 'name' | 'kana' | 'slug' | 'country' | 'avatarUrl' | 'twitterId' | 'streamingUrl' | 'birthday' | 'description'
> & {
    characters: Array<{ __typename?: 'Character' } & Pick<Character, 'name'>>;
    results: Array<
      { __typename?: 'TopPlayerResult' } & Pick<TopPlayerResult, 'id' | 'eventDate' | 'eventName' | 'ranking'>
    >;
  };

export type VideoFragment = { __typename?: 'Video' } & {
  tags: Array<{ __typename?: 'Tag' } & Pick<Tag, 'name'>>;
  highlights: Array<{ __typename?: 'Highlight' } & HighlightFragment>;
} & VideoSummaryFragment;

export type VideoCommentFragment = { __typename?: 'VideoComment' } & Pick<
  VideoComment,
  'id' | 'message' | 'createdAt'
> & { player: { __typename?: 'Player' } & Pick<Player, 'name' | 'avatarUrl'> };

export type VideoSummaryFragment = { __typename?: 'Video' } & Pick<
  Video,
  'id' | 'videoId' | 'channelTitle' | 'title' | 'thumbnailUrl' | 'faved' | 'favsCount' | 'commentCount'
>;

export type ConvertArticleVideoMutationVariables = Exact<{
  articleVideoId: Scalars['ID'];
}>;

export type ConvertArticleVideoMutation = { __typename?: 'Mutation' } & {
  convertArticleVideo?: Maybe<
    { __typename?: 'ConvertArticleVideoPayload' } & {
      articleVideo: { __typename?: 'ArticleVideo' } & Pick<ArticleVideo, 'm3u8Url' | 'thumbnailUrl'>;
    }
  >;
};
...
export type CreateArticleMutation = { __typename?: 'Mutation' } & {
  createArticle?: Maybe<
    { __typename?: 'CreateArticlePayload' } & { article: { __typename?: 'Article' } & Pick<Article, 'id'> }
  >;
};
...
export type CreateArticleCommentMutation = { __typename?: 'Mutation' } & {
  createArticleComment?: Maybe<
    { __typename?: 'CreateArticleCommentPayload' } & {
      articleComment: { __typename?: 'ArticleComment' } & ArticleCommentFragment;
    }
  >;
};
...
export type CreateArticleImageMutation = { __typename?: 'Mutation' } & {
  createArticleImage?: Maybe<{ __typename?: 'CreateArticleImagePayload' } & Pick<CreateArticleImagePayload, 'url'>>;
};
...
export type CreateArticleLinkMutation = { __typename?: 'Mutation' } & {
  createArticleLink?: Maybe<
    { __typename?: 'CreateArticleLinkPayload' } & { articleLink: { __typename?: 'ArticleLink' } & ArticleLinkFragment }
  >;
};

export type CreateArticleVideoMutationVariables = Exact<{ [key: string]: never }>;

export type CreateArticleVideoMutation = { __typename?: 'Mutation' } & {
  createArticleVideo?: Maybe<
    { __typename?: 'CreateArticleVideoPayload' } & {
      articleVideo: { __typename?: 'ArticleVideo' } & Pick<ArticleVideo, 'id'>;
      videoUpload: { __typename?: 'VideoUpload' } & Pick<VideoUpload, 'url' | 'fields'>;
    }
  >;
};
...
export type CreateAttackActionMutation = { __typename?: 'Mutation' } & {
  createAttackAction?: Maybe<
    { __typename?: 'CreateAttackActionPayload' } & { action: { __typename?: 'AttackAction' } & AttackActionFragment }
  >;
};
...
export type CreateComboMutation = { __typename?: 'Mutation' } & {
  createCombo?: Maybe<{ __typename?: 'CreateComboPayload' } & { combo: { __typename?: 'Combo' } & Pick<Combo, 'id'> }>;
};
...
export type CreateComboCategoryMutation = { __typename?: 'Mutation' } & {
  createComboCategory?: Maybe<
    { __typename?: 'CreateComboCategoryPayload' } & {
      comboCategory: { __typename?: 'ComboCategory' } & Pick<ComboCategory, 'id'>;
    }
  >;
};
...
export type CreateComboVideoMutation = { __typename?: 'Mutation' } & {
  createComboVideo?: Maybe<
    { __typename?: 'CreateComboVideoPayload' } & {
      comboVideo: { __typename?: 'ComboVideo' } & Pick<ComboVideo, 'id'>;
      videoUpload: { __typename?: 'VideoUpload' } & Pick<VideoUpload, 'url' | 'fields'>;
    }
  >;
};
...
export type CreateCommandMutation = { __typename?: 'Mutation' } & {
  createCommand?: Maybe<
    { __typename?: 'CreateCommandPayload' } & { command: { __typename?: 'Command' } & CommandFragment }
  >;
};
...
export type CreateEventMutation = { __typename?: 'Mutation' } & {
  createEvent?: Maybe<{ __typename?: 'CreateEventPayload' } & { event: { __typename?: 'Event' } & EventFragment }>;
};
...
export type CreateFrameMutation = { __typename?: 'Mutation' } & {
  createFrame?: Maybe<
    { __typename?: 'CreateFramePayload' } & {
      frame: { __typename?: 'Frame' } & Pick<Frame, 'id' | 'type' | 'frame' | 'state'>;
    }
  >;
};
...
export type CreateHighlightMutation = { __typename?: 'Mutation' } & {
  createHighlight?: Maybe<
    { __typename?: 'CreateHighlightPayload' } & { highlight: { __typename?: 'Highlight' } & HighlightFragment }
  >;
};
...
export type CreateMoveMutation = { __typename?: 'Mutation' } & {
  createMove?: Maybe<{ __typename?: 'CreateMovePayload' } & { move: { __typename?: 'Move' } & Pick<Move, 'id'> }>;
};
...
export type CreateMoveCategoryMutation = { __typename?: 'Mutation' } & {
  createMoveCategory?: Maybe<
    { __typename?: 'CreateMoveCategoryPayload' } & {
      moveCategory: { __typename?: 'MoveCategory' } & Pick<MoveCategory, 'id'>;
    }
  >;
};
...
export type CreateMoveCommentMutation = { __typename?: 'Mutation' } & {
  createMoveComment?: Maybe<
    { __typename?: 'CreateMoveCommentPayload' } & { moveComment: { __typename?: 'MoveComment' } & MoveCommentFragment }
  >;
};
...
export type CreateMoveVideoMutation = { __typename?: 'Mutation' } & {
  createMoveVideo?: Maybe<
    { __typename?: 'CreateMoveVideoPayload' } & {
      moveVideo: { __typename?: 'MoveVideo' } & Pick<MoveVideo, 'id'>;
      videoUpload: { __typename?: 'VideoUpload' } & Pick<VideoUpload, 'url' | 'fields'>;
    }
  >;
};
...
export type CreatePlayerWithEmailMutation = { __typename?: 'Mutation' } & {
  createPlayerWithEmail?: Maybe<
    { __typename?: 'CreatePlayerWithEmailPayload' } & {
      currentPlayer: { __typename?: 'CurrentPlayer' } & CurrentPlayerFragment;
    }
  >;
};
...
export type CreatePlayerWithTwitterMutation = { __typename?: 'Mutation' } & {
...
export type UpdateStageMutation = { __typename?: 'Mutation' } & {
  updateStage?: Maybe<{ __typename?: 'UpdateStagePayload' } & { stage: { __typename?: 'Stage' } & StageFragment }>;
};
...
export type CreateThrowActionMutation = { __typename?: 'Mutation' } & {
  createThrowAction?: Maybe<
    { __typename?: 'CreateThrowActionPayload' } & { action: { __typename?: 'ThrowAction' } & Pick<ThrowAction, 'id'> }
  >;
};
...
export type CreateVideoMutation = { __typename?: 'Mutation' } & {
  createVideo?: Maybe<{ __typename?: 'CreateVideoPayload' } & { video: { __typename?: 'Video' } & Pick<Video, 'id'> }>;
};
...
export type CreateVideoCommentMutation = { __typename?: 'Mutation' } & {
  createVideoComment?: Maybe<
    { __typename?: 'CreateVideoCommentPayload' } & {
      videoComment: { __typename?: 'VideoComment' } & VideoCommentFragment;
    }
  >;
};
...
export type CreateVideoFavMutation = { __typename?: 'Mutation' } & {
  createVideoFav?: Maybe<
    { __typename?: 'CreateVideoFavPayload' } & { video: { __typename?: 'Video' } & Pick<Video, 'id'> }
  >;
};
...
export type DeleteCommandMutation = { __typename?: 'Mutation' } & {
  deleteCommand?: Maybe<
    { __typename?: 'DeleteCommandPayload' } & { command: { __typename?: 'Command' } & Pick<Command, 'id'> }
  >;
};
...
export type DeleteFrameMutation = { __typename?: 'Mutation' } & {
  deleteFrame?: Maybe<{ __typename?: 'DeleteFramePayload' } & { frame: { __typename?: 'Frame' } & Pick<Frame, 'id'> }>;
};
...
export type DeleteHighlightMutation = { __typename?: 'Mutation' } & {
  deleteHighlight?: Maybe<
    { __typename?: 'DeleteHighlightPayload' } & { highlight: { __typename?: 'Highlight' } & Pick<Highlight, 'id'> }
  >;
};
...
export type DeleteMoveMutation = { __typename?: 'Mutation' } & {
  deleteMove?: Maybe<{ __typename?: 'DeleteMovePayload' } & { move: { __typename?: 'Move' } & MoveFragment }>;
};
...
export type DeleteVideoFavMutation = { __typename?: 'Mutation' } & {
  deleteVideoFav?: Maybe<
    { __typename?: 'DeleteVideoFavPayload' } & { video: { __typename?: 'Video' } & Pick<Video, 'id'> }
  >;
};
...
export type FavArticleMutation = { __typename?: 'Mutation' } & {
  favArticle?: Maybe<
    { __typename?: 'FavArticlePayload' } & { article: { __typename?: 'Article' } & Pick<Article, 'id'> }
  >;
};
...
export type PublishArticleMutation = { __typename?: 'Mutation' } & {
  publishArticle?: Maybe<
    { __typename?: 'PublishArticlePayload' } & { article: { __typename?: 'Article' } & ArticleSummaryFragment }
  >;
};

export type SetComboVideoMutationVariables = Exact<{
  comboId: Scalars['ID'];
  comboVideoId: Scalars['ID'];
}>;

export type SetComboVideoMutation = { __typename?: 'Mutation' } & {
  setComboVideo?: Maybe<
    { __typename?: 'SetComboVideoPayload' } & {
      comboVideo: { __typename?: 'ComboVideo' } & Pick<ComboVideo, 'm3u8Url' | 'thumbnailUrl'>;
    }
  >;
};
...
export type SetMoveVideoMutation = { __typename?: 'Mutation' } & {
  setMoveVideo?: Maybe<
    { __typename?: 'SetMoveVideoPayload' } & {
      moveVideo: { __typename?: 'MoveVideo' } & Pick<MoveVideo, 'm3u8Url' | 'thumbnailUrl'>;
    }
  >;
};
...
export type SetPlayerAvatarMutation = { __typename?: 'Mutation' } & {
  setPlayerAvatar?: Maybe<
    { __typename?: 'SetPlayerAvatarPayload' } & { player: { __typename?: 'Player' } & Pick<Player, 'avatarUrl'> }
  >;
};
...
export type StopArticleMutation = { __typename?: 'Mutation' } & {
  stopArticle?: Maybe<
    { __typename?: 'StopArticlePayload' } & { article: { __typename?: 'Article' } & ArticleSummaryFragment }
  >;
};
...
export type UnfavArticleMutation = { __typename?: 'Mutation' } & {
  unfavArticle?: Maybe<
    { __typename?: 'UnfavArticlePayload' } & { article: { __typename?: 'Article' } & Pick<Article, 'id'> }
  >;
};
...
export type UpdateArticleMutation = { __typename?: 'Mutation' } & {
  updateArticle?: Maybe<
    { __typename?: 'UpdateArticlePayload' } & { article: { __typename?: 'Article' } & Pick<Article, 'id'> }
  >;
};
...
export type UpdateCurrentPlayerMutation = { __typename?: 'Mutation' } & {
...
export type UpdateEventMutation = { __typename?: 'Mutation' } & {
  updateEvent?: Maybe<{ __typename?: 'UpdateEventPayload' } & { event: { __typename?: 'Event' } & EventFragment }>;
};
...
export type UpdateMoveMutation = { __typename?: 'Mutation' } & {
  updateMove?: Maybe<
    { __typename?: 'UpdateMovePayload' } & {
      move: { __typename?: 'Move' } & Pick<Move, 'id'> & {
          moveCategory: { __typename?: 'MoveCategory' } & Pick<MoveCategory, 'id'>;
        };
    }
  >;
...
export type CreateStageMutation = { __typename?: 'Mutation' } & {
  createStage?: Maybe<{ __typename?: 'CreateStagePayload' } & { stage: { __typename?: 'Stage' } & StageFragment }>;
};
...
export type ArticleQuery = { __typename?: 'Query' } & { article: { __typename?: 'Article' } & ArticleFragment };

export type ArticleCommentsQueryVariables = Exact<{
  articleId: Scalars['ID'];
}>;

export type ArticleCommentsQuery = { __typename?: 'Query' } & {
  articleComments: Array<{ __typename?: 'ArticleComment' } & ArticleCommentFragment>;
};

export type ArticlePathsQueryVariables = Exact<{ [key: string]: never }>;

export type ArticlePathsQuery = { __typename?: 'Query' } & {
  allArticles: Array<{ __typename?: 'Article' } & Pick<Article, 'id'>>;
};
...
export type ArticlesQuery = { __typename?: 'Query' } & {
  articles: { __typename?: 'ArticleConnection' } & {
    nodes?: Maybe<Array<Maybe<{ __typename?: 'Article' } & ArticleSummaryFragment>>>;
    pageInfo: { __typename?: 'PageInfo' } & PagingFragment;
  };
};
...
export type CharacterWithChildrenQuery = { __typename?: 'Query' } & {
  character: { __typename?: 'Character' } & CharacterWithChildrenFragment;
};

export type MoveCategoryWithMovesFragment = { __typename?: 'MoveCategory' } & {
  moves: Array<{ __typename?: 'Move' } & MoveFragment>;
} & MoveCategoryFragment;
...
export type CharacterMovesQuery = { __typename?: 'Query' } & {
  character: { __typename?: 'Character' } & Pick<
    Character,
    'slug' | 'longName' | 'faceImageUrl' | 'country' | 'fightingStyle' | 'story' | 'description'
  > & { moveCategories: Array<{ __typename?: 'MoveCategory' } & MoveCategoryWithMovesFragment> };
};

export type CharacterPathsQueryVariables = Exact<{ [key: string]: never }>;

export type CharacterPathsQuery = { __typename?: 'Query' } & {
  characters: Array<{ __typename?: 'Character' } & Pick<Character, 'slug'>>;
};

export type CharacterSlugsQueryVariables = Exact<{ [key: string]: never }>;

export type CharacterSlugsQuery = { __typename?: 'Query' } & {
  characters: Array<{ __typename?: 'Character' } & Pick<Character, 'slug'>>;
};
...
export type CharacterQuery = { __typename?: 'Query' } & { character: { __typename?: 'Character' } & CharacterFragment };

export type CharactersQueryVariables = Exact<{ [key: string]: never }>;

export type CharactersQuery = { __typename?: 'Query' } & {
  characters: Array<{ __typename?: 'Character' } & CharacterSummaryFragment>;
};
...
export type ComboCategoriesQuery = { __typename?: 'Query' } & {
  comboCategories: Array<{ __typename?: 'ComboCategory' } & ComboCategoryFragment>;
};
...
export type ComboCategoryQuery = { __typename?: 'Query' } & {
  comboCategory: { __typename?: 'ComboCategory' } & ComboCategoryWithCharacterFragment;
};
...
export type ComboCategoryDetailQuery = { __typename?: 'Query' } & {
  comboCategory: { __typename?: 'ComboCategory' } & ComboCategoryDetailFragment;
};

export type ComboCategoryIdsQueryVariables = Exact<{ [key: string]: never }>;

export type ComboCategoryIdsQuery = { __typename?: 'Query' } & {
  comboCategories: Array<{ __typename?: 'ComboCategory' } & Pick<ComboCategory, 'id'>>;
};
...
export type CombosQuery = { __typename?: 'Query' } & { combos: Array<{ __typename?: 'Combo' } & ComboFragment> };

export type CurrentPlayerQueryVariables = Exact<{ [key: string]: never }>;

export type CurrentPlayerQuery = { __typename?: 'Query' } & {
  currentPlayer: { __typename?: 'CurrentPlayer' } & CurrentPlayerFragment;
};
...
export type EventsQuery = { __typename?: 'Query' } & {
  events: { __typename?: 'EventConnection' } & {
    nodes?: Maybe<Array<Maybe<{ __typename?: 'Event' } & EventFragment>>>;
    pageInfo: { __typename?: 'PageInfo' } & PagingFragment;
  };
};
...
export type EventQuery = { __typename?: 'Query' } & { event: { __typename?: 'Event' } & EventFragment };

export type MoveQueryVariables = Exact<{
  moveId: Scalars['ID'];
}>;

export type MoveQuery = { __typename?: 'Query' } & { move: { __typename?: 'Move' } & MoveFragment };

export type MoveCategoriesQueryVariables = Exact<{
  characterSlug: Scalars['ID'];
}>;

export type MoveCategoriesQuery = { __typename?: 'Query' } & {
  moveCategories: Array<{ __typename?: 'MoveCategory' } & MoveCategoryFragment>;
};
...
export type MoveCategoryQuery = { __typename?: 'Query' } & {
  moveCategory: { __typename?: 'MoveCategory' } & MoveCategoryWithCharacterFragment;
};
...
export type MoveCategoryDetailQuery = { __typename?: 'Query' } & {
  moveCategory: { __typename?: 'MoveCategory' } & MoveCategoryDetailFragment;
};

export type MoveCategoryIdsQueryVariables = Exact<{ [key: string]: never }>;

export type MoveCategoryIdsQuery = { __typename?: 'Query' } & {
  moveCategories: Array<{ __typename?: 'MoveCategory' } & Pick<MoveCategory, 'id'>>;
};
...
export type MoveSelectOptionsQuery = { __typename?: 'Query' } & {
  moveCategories: Array<
    { __typename?: 'MoveCategory' } & Pick<MoveCategory, 'id' | 'name'> & {
        moves: Array<{ __typename?: 'Move' } & Pick<Move, 'id' | 'name'>>;
      }
  >;
};
...
export type MovesQuery = { __typename?: 'Query' } & { moves: Array<{ __typename?: 'Move' } & MoveFragment> };

export type MyArticleQueryVariables = Exact<{
  articleId: Scalars['ID'];
}>;

export type MyArticleQuery = { __typename?: 'Query' } & { myArticle: { __typename?: 'Article' } & ArticleFragment };
...
export type MyArticlesQuery = { __typename?: 'Query' } & {
  myArticles: { __typename?: 'ArticleConnection' } & {
    nodes?: Maybe<Array<Maybe<{ __typename?: 'Article' } & ArticleSummaryFragment>>>;
    pageInfo: { __typename?: 'PageInfo' } & PagingFragment;
  };
};
...
export type OperationsQuery = { __typename?: 'Query' } & {
  operations: Array<{ __typename?: 'Operation' } & OperationFragment>;
};
...
export type StageQuery = { __typename?: 'Query' } & { stage: { __typename?: 'Stage' } & StageFragment };

export type StagesQueryVariables = Exact<{ [key: string]: never }>;

export type StagesQuery = { __typename?: 'Query' } & { stages: Array<{ __typename?: 'Stage' } & StageFragment> };

export type StatesQueryVariables = Exact<{
  characterSlug: Scalars['ID'];
}>;

export type StatesQuery = { __typename?: 'Query' } & { states: Array<{ __typename?: 'State' } & StateFragment> };

export type TopPlayersQueryVariables = Exact<{ [key: string]: never }>;

export type TopPlayersQuery = { __typename?: 'Query' } & {
  topPlayers: Array<{ __typename?: 'TopPlayer' } & TopPlayerFragment>;
};
...
export type VideoQuery = { __typename?: 'Query' } & { video: { __typename?: 'Video' } & VideoFragment };

export type VideoCommentsQueryVariables = Exact<{
  videoId: Scalars['ID'];
}>;

export type VideoCommentsQuery = { __typename?: 'Query' } & {
  videoComments: Array<{ __typename?: 'VideoComment' } & VideoCommentFragment>;
};
...
export type VideosQuery = { __typename?: 'Query' } & {
  videos: { __typename?: 'VideoConnection' } & {
    nodes?: Maybe<Array<Maybe<{ __typename?: 'Video' } & VideoSummaryFragment>>>;
    pageInfo: { __typename?: 'PageInfo' } & PagingFragment;
  };
};
...
export const MoveCategoryWithMovesFragmentDoc = gql`
  ...
  ${MoveFragmentDoc}
`;
export const ConvertArticleVideoDocument = gql`
  mutation ConvertArticleVideo($articleVideoId: ID!) {
    convertArticleVideo(input: { articleVideoId: $articleVideoId }) {
      articleVideo {
        m3u8Url
        thumbnailUrl
      }
...
`;
export type ConvertArticleVideoMutationFn = Apollo.MutationFunction<
  ConvertArticleVideoMutation,
  ConvertArticleVideoMutationVariables
>;

/**
 * __useConvertArticleVideoMutation__
 *
 * To run a mutation, you first call `useConvertArticleVideoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useConvertArticleVideoMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [convertArticleVideoMutation, { data, loading, error }] = useConvertArticleVideoMutation({
 *   variables: {
 *      articleVideoId: // value for 'articleVideoId'
 *   },
 * });
 */
export function useConvertArticleVideoMutation(
  baseOptions?: Apollo.MutationHookOptions<ConvertArticleVideoMutation, ConvertArticleVideoMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<ConvertArticleVideoMutation, ConvertArticleVideoMutationVariables>(
    ConvertArticleVideoDocument,
    options,
  );
}
export type ConvertArticleVideoMutationHookResult = ReturnType<typeof useConvertArticleVideoMutation>;
export type ConvertArticleVideoMutationResult = Apollo.MutationResult<ConvertArticleVideoMutation>;
export type ConvertArticleVideoMutationOptions = Apollo.BaseMutationOptions<
  ConvertArticleVideoMutation,
  ConvertArticleVideoMutationVariables
>;
...
export function useCreateArticleCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateArticleCommentMutation, CreateArticleCommentMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateArticleCommentMutation, CreateArticleCommentMutationVariables>(
    CreateArticleCommentDocument,
    options,
  );
}
...
export const CreateAttackActionDocument = gql`
  ...
  ${AttackActionFragmentDoc}
`;
export type CreateAttackActionMutationFn = Apollo.MutationFunction<
  CreateAttackActionMutation,
  CreateAttackActionMutationVariables
>;
 ...
 * });
 */
export function useCreateAttackActionMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateAttackActionMutation, CreateAttackActionMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateAttackActionMutation, CreateAttackActionMutationVariables>(
    CreateAttackActionDocument,
    options,
  );
}
...
export type CreateAttackActionMutationOptions = Apollo.BaseMutationOptions<
  CreateAttackActionMutation,
  CreateAttackActionMutationVariables
>;
export const CreateComboDocument = gql`
  mutation CreateCombo($attributes: ComboAttributes!) {
    createCombo(input: { attributes: $attributes }) {
      combo {
        id
      }
    }
...
export const CreateComboVideoDocument = gql`
  mutation CreateComboVideo($characterSlug: ID!) {
    createComboVideo(input: { characterSlug: $characterSlug }) {
      comboVideo {
        id
      }
      videoUpload {
...
export function useCreateCommandMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateCommandMutation, CreateCommandMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type CreateCommandMutationOptions = Apollo.BaseMutationOptions<
...
export function useCreateFrameMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateFrameMutation, CreateFrameMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export const CreateHighlightDocument = gql`
  ...
  ${HighlightFragmentDoc}
`;
export type CreateHighlightMutationFn = Apollo.MutationFunction<
...
export function useCreateHighlightMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateHighlightMutation, CreateHighlightMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateHighlightMutation, CreateHighlightMutationVariables>(
    CreateHighlightDocument,
    options,
  );
}
...
export type CreateHighlightMutationOptions = Apollo.BaseMutationOptions<
  CreateHighlightMutation,
  CreateHighlightMutationVariables
>;
 ...
 * });
 */
export function useCreateMoveMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateMoveMutation, CreateMoveMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
`;
export type CreateMoveCommentMutationFn = Apollo.MutationFunction<
  CreateMoveCommentMutation,
  CreateMoveCommentMutationVariables
>;
 ...
 * });
 */
export function useCreateMoveCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateMoveCommentMutation, CreateMoveCommentMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateMoveCommentMutation, CreateMoveCommentMutationVariables>(
    CreateMoveCommentDocument,
    options,
  );
}
...
export type CreateMoveCommentMutationOptions = Apollo.BaseMutationOptions<
  CreateMoveCommentMutation,
  CreateMoveCommentMutationVariables
>;
...
`;
export type CreatePlayerWithEmailMutationFn = Apollo.MutationFunction<
  CreatePlayerWithEmailMutation,
  CreatePlayerWithEmailMutationVariables
>;
 ...
 * });
 */
export function useCreatePlayerWithEmailMutation(
  baseOptions?: Apollo.MutationHookOptions<CreatePlayerWithEmailMutation, CreatePlayerWithEmailMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreatePlayerWithEmailMutation, CreatePlayerWithEmailMutationVariables>(
    CreatePlayerWithEmailDocument,
    options,
  );
}
...
export type CreatePlayerWithEmailMutationOptions = Apollo.BaseMutationOptions<
  CreatePlayerWithEmailMutation,
  CreatePlayerWithEmailMutationVariables
>;
export const CreatePlayerWithTwitterDocument = gql`
  ...
  ${CurrentPlayerFragmentDoc}
`;
export type CreatePlayerWithTwitterMutationFn = Apollo.MutationFunction<
  CreatePlayerWithTwitterMutation,
  CreatePlayerWithTwitterMutationVariables
>;
 ...
 * });
 */
export function useCreatePlayerWithTwitterMutation(
  baseOptions?: Apollo.MutationHookOptions<CreatePlayerWithTwitterMutation, CreatePlayerWithTwitterMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreatePlayerWithTwitterMutation, CreatePlayerWithTwitterMutationVariables>(
    CreatePlayerWithTwitterDocument,
    options,
  );
}
...
export type CreatePlayerWithTwitterMutationOptions = Apollo.BaseMutationOptions<
  CreatePlayerWithTwitterMutation,
  CreatePlayerWithTwitterMutationVariables
>;
...
export function useUpdateStageMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateStageMutation, UpdateStageMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
`;
export type CreateThrowActionMutationFn = Apollo.MutationFunction<
  CreateThrowActionMutation,
  CreateThrowActionMutationVariables
>;
 ...
 * });
 */
export function useCreateThrowActionMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateThrowActionMutation, CreateThrowActionMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateThrowActionMutation, CreateThrowActionMutationVariables>(
    CreateThrowActionDocument,
    options,
  );
}
...
export type CreateThrowActionMutationOptions = Apollo.BaseMutationOptions<
  CreateThrowActionMutation,
  CreateThrowActionMutationVariables
>;
...
export const CreateVideoCommentDocument = gql`
  mutation CreateVideoComment($videoId: ID!, $attributes: VideoCommentAttributes!) {
...
`;
export type CreateVideoCommentMutationFn = Apollo.MutationFunction<
  CreateVideoCommentMutation,
  CreateVideoCommentMutationVariables
>;
 ...
 * });
 */
export function useCreateVideoCommentMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateVideoCommentMutation, CreateVideoCommentMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateVideoCommentMutation, CreateVideoCommentMutationVariables>(
    CreateVideoCommentDocument,
    options,
  );
}
...
export type CreateVideoCommentMutationOptions = Apollo.BaseMutationOptions<
  CreateVideoCommentMutation,
  CreateVideoCommentMutationVariables
>;
 ...
 * });
 */
export function useCreateVideoFavMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateVideoFavMutation, CreateVideoFavMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type CreateVideoFavMutationOptions = Apollo.BaseMutationOptions<
  CreateVideoFavMutation,
  CreateVideoFavMutationVariables
>;
...
export function useDeleteCommandMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteCommandMutation, DeleteCommandMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type DeleteCommandMutationOptions = Apollo.BaseMutationOptions<
...
export function useDeleteFrameMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteFrameMutation, DeleteFrameMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useDeleteHighlightMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteHighlightMutation, DeleteHighlightMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useDeleteVideoFavMutation(
  baseOptions?: Apollo.MutationHookOptions<DeleteVideoFavMutation, DeleteVideoFavMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type DeleteVideoFavMutationOptions = Apollo.BaseMutationOptions<
  DeleteVideoFavMutation,
  DeleteVideoFavMutationVariables
>;
...
>;
export const SetComboVideoDocument = gql`
  mutation setComboVideo($comboId: ID!, $comboVideoId: ID!) {
    setComboVideo(input: { comboId: $comboId, comboVideoId: $comboVideoId }) {
      comboVideo {
        m3u8Url
        thumbnailUrl
      }
...
`;
export type SetComboVideoMutationFn = Apollo.MutationFunction<SetComboVideoMutation, SetComboVideoMutationVariables>;

/**
 * __useSetComboVideoMutation__
 *
 * To run a mutation, you first call `useSetComboVideoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetComboVideoMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [setComboVideoMutation, { data, loading, error }] = useSetComboVideoMutation({
 *   variables: {
 *      comboId: // value for 'comboId'
 *      comboVideoId: // value for 'comboVideoId'
 *   },
 * });
 */
export function useSetComboVideoMutation(
  baseOptions?: Apollo.MutationHookOptions<SetComboVideoMutation, SetComboVideoMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<SetComboVideoMutation, SetComboVideoMutationVariables>(SetComboVideoDocument, options);
}
export type SetComboVideoMutationHookResult = ReturnType<typeof useSetComboVideoMutation>;
export type SetComboVideoMutationResult = Apollo.MutationResult<SetComboVideoMutation>;
export type SetComboVideoMutationOptions = Apollo.BaseMutationOptions<
  SetComboVideoMutation,
  SetComboVideoMutationVariables
>;
 ...
 * });
 */
export function useSetMoveVideoMutation(
  baseOptions?: Apollo.MutationHookOptions<SetMoveVideoMutation, SetMoveVideoMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export type SetMoveVideoMutationOptions = Apollo.BaseMutationOptions<
  SetMoveVideoMutation,
  SetMoveVideoMutationVariables
>;
...
`;
export type SetPlayerAvatarMutationFn = Apollo.MutationFunction<
  SetPlayerAvatarMutation,
  SetPlayerAvatarMutationVariables
>;
 ...
 * });
 */
export function useSetPlayerAvatarMutation(
  baseOptions?: Apollo.MutationHookOptions<SetPlayerAvatarMutation, SetPlayerAvatarMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<SetPlayerAvatarMutation, SetPlayerAvatarMutationVariables>(
    SetPlayerAvatarDocument,
    options,
  );
}
...
export type SetPlayerAvatarMutationOptions = Apollo.BaseMutationOptions<
  SetPlayerAvatarMutation,
  SetPlayerAvatarMutationVariables
>;
...
export const UpdateCurrentPlayerDocument = gql`
  ...
  ${CurrentPlayerFragmentDoc}
`;
export type UpdateCurrentPlayerMutationFn = Apollo.MutationFunction<
  UpdateCurrentPlayerMutation,
  UpdateCurrentPlayerMutationVariables
>;
 ...
 * });
 */
export function useUpdateCurrentPlayerMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateCurrentPlayerMutation, UpdateCurrentPlayerMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<UpdateCurrentPlayerMutation, UpdateCurrentPlayerMutationVariables>(
    UpdateCurrentPlayerDocument,
    options,
  );
}
...
export type UpdateCurrentPlayerMutationOptions = Apollo.BaseMutationOptions<
  UpdateCurrentPlayerMutation,
  UpdateCurrentPlayerMutationVariables
>;
 ...
 * });
 */
export function useUpdateMoveMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateMoveMutation, UpdateMoveMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useCreateStageMutation(
  baseOptions?: Apollo.MutationHookOptions<CreateStageMutation, CreateStageMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useArticleCommentsQuery(
  baseOptions: Apollo.QueryHookOptions<ArticleCommentsQuery, ArticleCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useArticleCommentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ArticleCommentsQuery, ArticleCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useCharacterWithChildrenQuery(
  baseOptions: Apollo.QueryHookOptions<CharacterWithChildrenQuery, CharacterWithChildrenQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CharacterWithChildrenQuery, CharacterWithChildrenQueryVariables>(
    CharacterWithChildrenDocument,
    options,
  );
}
export function useCharacterWithChildrenLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<CharacterWithChildrenQuery, CharacterWithChildrenQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<CharacterWithChildrenQuery, CharacterWithChildrenQueryVariables>(
    CharacterWithChildrenDocument,
    options,
  );
}
...
export type CharacterWithChildrenQueryResult = Apollo.QueryResult<
  CharacterWithChildrenQuery,
  CharacterWithChildrenQueryVariables
>;
 ...
 * });
 */
export function useCharacterMovesQuery(
  baseOptions: Apollo.QueryHookOptions<CharacterMovesQuery, CharacterMovesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CharacterMovesQuery, CharacterMovesQueryVariables>(CharacterMovesDocument, options);
}
export function useCharacterMovesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<CharacterMovesQuery, CharacterMovesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useComboCategoriesQuery(
  baseOptions: Apollo.QueryHookOptions<ComboCategoriesQuery, ComboCategoriesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ComboCategoriesQuery, ComboCategoriesQueryVariables>(ComboCategoriesDocument, options);
}
export function useComboCategoriesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ComboCategoriesQuery, ComboCategoriesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useComboCategoryQuery(
  baseOptions: Apollo.QueryHookOptions<ComboCategoryQuery, ComboCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ComboCategoryQuery, ComboCategoryQueryVariables>(ComboCategoryDocument, options);
}
export function useComboCategoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ComboCategoryQuery, ComboCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useComboCategoryDetailQuery(
  baseOptions: Apollo.QueryHookOptions<ComboCategoryDetailQuery, ComboCategoryDetailQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ComboCategoryDetailQuery, ComboCategoryDetailQueryVariables>(
    ComboCategoryDetailDocument,
    options,
  );
}
export function useComboCategoryDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ComboCategoryDetailQuery, ComboCategoryDetailQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ComboCategoryDetailQuery, ComboCategoryDetailQueryVariables>(
    ComboCategoryDetailDocument,
    options,
  );
}
...
export type ComboCategoryDetailQueryResult = Apollo.QueryResult<
  ComboCategoryDetailQuery,
  ComboCategoryDetailQueryVariables
>;
...
export function useCurrentPlayerQuery(
  baseOptions?: Apollo.QueryHookOptions<CurrentPlayerQuery, CurrentPlayerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CurrentPlayerQuery, CurrentPlayerQueryVariables>(CurrentPlayerDocument, options);
}
export function useCurrentPlayerLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<CurrentPlayerQuery, CurrentPlayerQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useMoveCategoriesQuery(
  baseOptions: Apollo.QueryHookOptions<MoveCategoriesQuery, MoveCategoriesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MoveCategoriesQuery, MoveCategoriesQueryVariables>(MoveCategoriesDocument, options);
}
export function useMoveCategoriesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MoveCategoriesQuery, MoveCategoriesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useMoveCategoryQuery(
  baseOptions: Apollo.QueryHookOptions<MoveCategoryQuery, MoveCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MoveCategoryQuery, MoveCategoryQueryVariables>(MoveCategoryDocument, options);
}
export function useMoveCategoryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MoveCategoryQuery, MoveCategoryQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useMoveCategoryDetailQuery(
  baseOptions: Apollo.QueryHookOptions<MoveCategoryDetailQuery, MoveCategoryDetailQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MoveCategoryDetailQuery, MoveCategoryDetailQueryVariables>(
    MoveCategoryDetailDocument,
    options,
  );
}
export function useMoveCategoryDetailLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MoveCategoryDetailQuery, MoveCategoryDetailQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MoveCategoryDetailQuery, MoveCategoryDetailQueryVariables>(
    MoveCategoryDetailDocument,
    options,
  );
}
...
export type MoveCategoryDetailQueryResult = Apollo.QueryResult<
  MoveCategoryDetailQuery,
  MoveCategoryDetailQueryVariables
>;
...
export function useOperationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<OperationsQuery, OperationsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useTopPlayersLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TopPlayersQuery, TopPlayersQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useVideoCommentsQuery(
  baseOptions: Apollo.QueryHookOptions<VideoCommentsQuery, VideoCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<VideoCommentsQuery, VideoCommentsQueryVariables>(VideoCommentsDocument, options);
}
export function useVideoCommentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<VideoCommentsQuery, VideoCommentsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
