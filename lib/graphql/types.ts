...
export type CreateMoveVideoInput = {
  moveId: Scalars['ID'];
  attributes: MoveVideoAttributes;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
};
...
export type MoveVideoAttributes = {
  youtubeVideoId: Scalars['String'];
  comment: Scalars['String'];
};
...
export type MoveVideoFragment = (
  { __typename?: 'MoveVideo' }
  & Pick<MoveVideo, 'id' | 'youtubeVideoId' | 'comment'>
);
...
export const CreateMoveVideoDocument = gql`
    mutation CreateMoveVideo($moveId: ID!, $attributes: MoveVideoAttributes!) {
  createMoveVideo(input: {moveId: $moveId, attributes: $attributes}) {
    moveVideo {
      ...moveVideo
    }
  }
