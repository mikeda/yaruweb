...
export type CurrentPlayerFragment = (
  { __typename?: 'CurrentPlayer' }
  & Pick<CurrentPlayer, 'id' | 'name' | 'slug' | 'role' | 'avatarUrl'>
);
...
export type StageFragment = (
  { __typename?: 'Stage' }
  & Pick<Stage, 'id' | 'name' | 'mainImageUrl' | 'infinite' | 'wall' | 'wallBreak' | 'balconyBreak' | 'floorBreak'>
);
...
export type ConvertArticleVideoMutation = (
  { __typename?: 'Mutation' }
  & { convertArticleVideo?: Maybe<(
    { __typename?: 'ConvertArticleVideoPayload' }
    & { articleVideo: (
      { __typename?: 'ArticleVideo' }
      & Pick<ArticleVideo, 'm3u8Url' | 'thumbnailUrl'>
    ) }
  )> }
);
...
export type SetComboVideoMutation = (
  { __typename?: 'Mutation' }
  & { setComboVideo?: Maybe<(
    { __typename?: 'SetComboVideoPayload' }
    & { comboVideo: (
      { __typename?: 'ComboVideo' }
      & Pick<ComboVideo, 'm3u8Url' | 'thumbnailUrl'>
    ) }
  )> }
);
...
export const ConvertArticleVideoDocument = gql`
  ...
  convertArticleVideo(input: {articleVideoId: $articleVideoId}) {
    ...
    `;
export type ConvertArticleVideoMutationFn = Apollo.MutationFunction<ConvertArticleVideoMutation, ConvertArticleVideoMutationVariables>;
 ...
 * });
 */
export function useConvertArticleVideoMutation(baseOptions?: Apollo.MutationHookOptions<ConvertArticleVideoMutation, ConvertArticleVideoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ConvertArticleVideoMutation, ConvertArticleVideoMutationVariables>(ConvertArticleVideoDocument, options);
      }
...
export type ConvertArticleVideoMutationOptions = Apollo.BaseMutationOptions<ConvertArticleVideoMutation, ConvertArticleVideoMutationVariables>;
...
export const CreateComboCategoryDocument = gql`
    mutation CreateComboCategory($characterId: ID!, $attributes: ComboCategoryAttributes!) {
  createComboCategory(input: {characterId: $characterId, attributes: $attributes}) {
    comboCategory {
      id
    }
  }
...
export const CreateComboVideoDocument = gql`
    mutation CreateComboVideo($characterId: ID!) {
  createComboVideo(input: {characterId: $characterId}) {
    comboVideo {
      id
    }
    videoUpload {
...
export const CreateMoveCategoryDocument = gql`
    mutation CreateMoveCategory($characterId: ID!, $attributes: MoveCategoryAttributes!) {
  createMoveCategory(input: {characterId: $characterId, attributes: $attributes}) {
    moveCategory {
      id
    }
  }
 ...
 * });
 */
export function useSetComboVideoMutation(baseOptions?: Apollo.MutationHookOptions<SetComboVideoMutation, SetComboVideoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type SetComboVideoMutationOptions = Apollo.BaseMutationOptions<SetComboVideoMutation, SetComboVideoMutationVariables>;
